...
import { ComplianceBreachData } from "@/types";
import { 
  BarChart, 
  Bar, 
  XAxis, 
...
interface ComplianceBreachChartProps {
  data: ComplianceBreachData;
}

export const ComplianceBreachChart = ({ data }: ComplianceBreachChartProps) => {
  const colors = [
    "#7EBB3F", // avocado-500
    "#D2E4B6", // avocado-200
    "#4C7025", // avocado-700
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Total breaches: {data.quantity} ({data.percentage.toFixed(1)}%)
        </CardDescription>
      </CardHeader>
      <CardContent>
              ...
              <div className="w-full md:w-1/2 h-[300px]">
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <YAxis />
                    <Tooltip />
                    <Bar dataKey="value" name="Breaches" fill="#7EBB3F">
